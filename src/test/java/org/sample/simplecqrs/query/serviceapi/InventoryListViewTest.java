package org.sample.simplecqrs.query.serviceapi;
...
@Ignore
public class InventoryListViewTest extends AbstractDependencyInjectionSpringContextTests implements
        InventoryListViewTestBase {
    @Autowired
